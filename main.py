...
def build_model(args, factory):
    if args.model in ['gcn', 'gat', 'hgcn', 'hgat']:
        ...
        model = HGNNLP(factory.num_nodes, factory.node_feats_dim, factory.edge_feats_dim,
                            ...
                            layers=args.n_layers, heads=args.heads, time_encoder=args.time_encoder).to(args.device)
...
if __name__ == "__main__":
    ...
    DS = {'bitcoinotc': BitcoinOTC, 'bitcoinalpha': BitcoinAlpha, 
            'uci': UCIMessage, 'as733': AS733, 'sbm': SBM, 'stackoverflow': StackOverflow}
    split = {
    ...
    root = {'bitcoinotc': './data/bitcoin', 'bitcoinalpha': './data/bitcoin', 
        'uci': './data/uci-msg', 'as733': './data/as-733', 'sbm': './data/sbm', 
        'stackoverflow': './data/stackoverflow'}
    
    if args.dataset in ['bitcoinotc', 'bitcoinalpha', 'uci', 'as733', 'sbm', 'stackoverflow']:
