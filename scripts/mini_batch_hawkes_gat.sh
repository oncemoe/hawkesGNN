...
python main.py --device $gpu --runs $runs --model hgat --minibatch --bias 

python main.py --device $gpu --runs $runs --model hgat --minibatch --bias  --dataset bitcoinalpha

python main.py --device $gpu --runs $runs --model hgat --minibatch --bias  --dataset uci

python main.py --device $gpu --runs $runs --model hgat --minibatch --bias  --dataset redt
