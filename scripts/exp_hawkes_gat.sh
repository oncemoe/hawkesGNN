...
echo python main.py --device $gpu --runs $runs --model hgat --bias --bn --dataset uci --exp_name window-$i --window $i
python main.py --device $gpu --runs $runs --model hgat --bias --bn --dataset uci --exp_name window-$i --window $i
done
